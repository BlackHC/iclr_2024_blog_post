...
\begin{tcolorbox}[colback=green!5!white,colframe=teal!75!black,title=KL TK ]
...
\block{Function-Space Variational Inference}
{
  ...
  \begin{multicols}{2}
    ...
    \begin{tcolorbox}[colback=green!5!white,colframe=teal!75!black,title=Prediction Equivalence]
      ...
      This commutative property is not unique to the equivalence class mapping but rather a general characteristic of applying functions to random variables. The mapping $[\cdot]$ transforms the random variable $\W$ into a new random variable $[\W]$, and this transformation commutes with Bayesian inference (of course?).
      \innerblock{Commutative Diagram of Bayesian Inference and Equivalence Mapping}{
        \begin{tikzfigure}
        ...
        \end{tikzfigure}
      \begin{center}
        This diagram illustrates that the mapping of parameters into their equivalence classes commutes with Bayesian inference.
      \end{center}
      } 
