...
\begin{columns}
  ...
  \begin{subcolumns}
    ...
    {
      \colorlet{blockbodybgcolor}{solarized-orange!10!white}    
      \block{\small Failure for Bayesian Linear Regression}{
        % \vspace{1em}
        % \begin{multicols}{2}
        %   \vfill
