...
\title{Bayesian Model Selection: Marginal Likelihood, CV, CLML, and Beyond}
...
\begin{columns}
  ...
  \block{Occam's Razor}{
    ...
    \end{quotebox}
    \begin{tldrbox}
      Occam's Razor \& Bayesian Model Selection:\\
      Minimize information, maximize likelihood\\
      \textbf{BUT} ambiguous about multiple data points \& objectives
    \end{tldrbox}
    ...
    \begin{theorybox}[title=Multiple vs Individual Points]
      ...
      \begin{itemize}
      \item \textbf{Joint Quantities} (e.g., joint marginal cross-entropy, conditional joint marginal information) substitute the dataset directly, e.g. $\Hof{\Dataset\given\h}$, and entail \textbf{in-context learning}.
  ...
  {
    \colorlet{blockbodybgcolor}{solarized-base00!5!white} 
    \block{References}
    {
      \small
  ...
  \block{}{
    \vspace{0.5em}
    \centering
    \includegraphics[width=\linewidth]{clml_qr_code.png}
  }
  \end{subcolumns}
\end{columns}
\end{document}
