...
While Lotfi et al. (2022/2023) provide a comprehensive analysis of the limitations of the marginal likelihood and propose the CLML as an alternative, there are several aspects of their work that warrant further scrutiny and criticism.

First, the authors' claim that the CLML is a novel contribution is debatable, given its significant similarities to earlier works, such as the cumulative leave-p-out cross-validation score proposed by Fong and Holmes (2020)<d-cite key="fong2020marginal"></d-cite> and the TSE estimators introduced by Lyle et al. (2020)<d-cite key="lyle2020bayesian"></d-cite> and Ru et al. (2021)<d-cite key="ru2021speedy"></d-cite>. While Lotfi et al. acknowledge these connections, they do not provide a clear and convincing argument for how the CLML substantially differs from or improves upon these existing approaches. The authors could have done a better job of highlighting the unique aspects of the CLML and demonstrating its superiority over related methods.

Second, the empirical evaluations presented in the paper, although extensive, may not be sufficient to establish the CLML as a reliable and universally applicable metric for Bayesian model selection and hyperparameter learning. The experiments focus primarily on neural architecture search and deep kernel learning, which are specific domains with their own characteristics and challenges. It remains unclear whether the CLML would exhibit similar performance and advantages in other settings, such as Bayesian optimization, active learning, or probabilistic modeling with different types of architectures and priors. The authors could have strengthened their claims by including a more diverse set of experiments and discussing the potential limitations of the CLML in various contexts.

Third, the theoretical analysis of the CLML in the paper is somewhat limited. While the authors provide some intuition and justification for the CLML, they do not offer a rigorous mathematical treatment of its properties, such as its asymptotic behavior, convergence rates, or robustness to model misspecification. A more in-depth theoretical analysis could have helped to establish the CLML on a firmer foundation and provide a clearer understanding of its strengths and weaknesses compared to the marginal likelihood and other metrics.

Fourth, the computational aspects of estimating the CLML are not thoroughly addressed in the paper. The authors mention the potential challenges in computing the CLML for complex models, but do not provide concrete guidelines or recommendations for practitioners. In practice, estimating the CLML may require sophisticated sampling techniques or approximations, which can be computationally expensive and introduce additional sources of error. The authors could have discussed these issues in more detail and proposed strategies for mitigating them.

Finally, while the authors acknowledge some limitations of their work and suggest directions for future research, they do not provide a clear roadmap for addressing these challenges. For example, they mention the need for further theoretical analysis of the CLML's properties and the potential extensions to other settings, but do not offer specific proposals or hypotheses for how these goals could be achieved. A more detailed discussion of the open questions and potential avenues for future work could have made the paper more impactful and stimulating for the research community.

In conclusion, while Lotfi et al. (2022/2023) make a valuable contribution to the discussion of Bayesian model selection and evaluation, their work has several limitations and areas for improvement. The novelty and superiority of the CLML compared to existing approaches are not fully established, the empirical evaluations may not be comprehensive enough, the theoretical analysis is limited, the computational aspects are not thoroughly addressed, and the directions for future research are not clearly outlined. Addressing these issues could have strengthened the paper's claims and impact, and provided a more solid foundation for further investigations into the CLML and its applications in Bayesian machine learning.
