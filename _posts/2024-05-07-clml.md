...
description: >-
  ...
  This blog post explores the connections between the log marginal likelihood (LML), cross-validation, and the recently proposed conditional marginal log-likelihood (CLML) for model selection in Bayesian machine learning. It discusses the theoretical foundations, practical implications, and empirical results of using these metrics for model comparison and hyperparameter tuning. The post also examines the challenges and limitations of computing the CLML for deep neural networks (DNNs) and compares it to the traditional validation loss.
date: 2024-05-07
future: true
htmlwidgets: true
tags:
